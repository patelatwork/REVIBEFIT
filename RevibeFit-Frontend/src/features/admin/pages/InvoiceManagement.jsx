        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-20 lg:pt-8">
          ...
          <div className="mb-6 flex space-x-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${filterStatus === 'overdue'
                ? 'bg-[#3f8554] text-white'
                : 'bg-white text-gray-700 hover:bg-gray-100'
                }`}
            >
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      {labPartners.map((labPartner) => (
                        <div
                          key={labPartner._id}
                          className={`border rounded-lg p-4 cursor-pointer transition-all ${selectedLabPartners.includes(labPartner._id)
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg font-medium transition-all ${invoiceTimeWindow === 'monthly'
                    ...
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg font-medium transition-all ${invoiceTimeWindow === 'weekly'
                        ? 'bg-[#3f8554] text-white ring-2 ring-[#3f8554]'
                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg font-medium transition-all ${invoiceTimeWindow === 'custom'
                        ? 'bg-[#3f8554] text-white ring-2 ring-[#3f8554]'
                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                        }`}
                    >
