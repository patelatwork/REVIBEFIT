                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-2">
                      <div className="flex items-center mb-4">
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl ${user.userType === 'trainer' ? 'bg-orange-500' : 'bg-purple-500'
                          }`}>
                          {user.name.charAt(0).toUpperCase()}
                        </div>
                        <div className="ml-4">
                          <h3 className="text-xl font-semibold text-[#225533]">{user.name}</h3>
                          <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${user.userType === 'trainer'
