...
const CreateChallenge = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        navigate(`/community/challenge/${data.data._id}`);
      } else {
    ...
    <div className="min-h-screen bg-[#fafaf5]">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <Link
          ...
          className="inline-flex items-center gap-1 text-gray-500 hover:text-[#225533] text-sm mb-6 transition-colors"
        >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-[#225533] to-[#3f8554] px-6 py-5">
            <h1 className="text-2xl font-bold text-white flex items-center gap-2">
              <Trophy size={24} /> Create a Challenge
            </h1>
            <p className="text-green-100 text-sm mt-1">
              Inspire the community with a fitness challenge
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-[#3f8554] focus:outline-none focus:ring-2 focus:ring-[#3f8554]/20 text-sm"
                required
                minLength={5}
                maxLength={200}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe the challenge, what participants will do, and why it's worth joining..."
                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-[#3f8554] focus:outline-none focus:ring-2 focus:ring-[#3f8554]/20 text-sm resize-none"
                rows={4}
                required
                minLength={20}
                maxLength={5000}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-[#3f8554] focus:outline-none text-sm"
                  required
                />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                {goalTypes.map((gt) => (
                  ...
                  >
                    <div>{gt.label}</div>
                    <div className="text-[10px] mt-0.5 opacity-80">{gt.desc}</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g., pushups, minutes, days"
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-[#3f8554] focus:outline-none text-sm"
                  required
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="e.g., Must log daily | No skipping more than 2 days | Be honest with your logs"
                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-[#3f8554] focus:outline-none text-sm resize-none"
                rows={2}
              />
            </div>
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 block mb-1.5">
                <Image size={14} className="inline mr-1" /> Cover Image (optional)
              </label>
              {coverPreview && (
                <div className="mb-2 relative rounded-lg overflow-hidden h-40">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 px-2 py-1 bg-black/50 text-white text-xs rounded hover:bg-red-500 transition-colors"
                  >
                    Remove
                  </button>
                </div>
